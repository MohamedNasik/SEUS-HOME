            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="admin.php"> Test Information</a>
                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    <h4>Details of the Testings conduct in the Hospital</h4>
...
$sqli = "SELECT * FROM testings ORDER BY test_id ASC ";
