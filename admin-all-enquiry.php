            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="admin.php"> Test Details</a>
                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inn-sp">
                                <div class="inn-title">
                                    <h4>Submitted Testings Details</h4>
...
$sqli = "SELECT * FROM testing_schedule WHERE p_id= '".$_SESSION['p_id']."' ORDER BY testing_schedule_id DESC ";
...
?>
                                                <tr>
                                                   ...
                                                   <td><?php  echo $row['testing_schedule_id'];   ?></td>
                                                    <td><?php  echo $row['testing_perform'];   ?></td>
