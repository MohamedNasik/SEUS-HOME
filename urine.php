...
<?php
        // Initialize the session
         ...
         if(!isset($_SESSION['p_id'])){
            ...
            { 
                $output = '';
                $stmt = $conn->prepare("SELECT * FROM testing_report as tr INNER JOIN testing_schedule as ts ON tr.test_id=ts.test_id AND tr.pres_id=ts.pres_id AND ts.p_id='".$_SESSION['p_id']."' AND tr.test_id='2' AND ts.payment_status='2' GROUP BY ts.pres_id ORDER BY tr.testing_report_id DESC");
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>                                        
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center"><span id="14"> </span></td>   
                                                </tr>
                                                ...
                                                <tr>
                                                    <td class="center" colspan="3"> <h5><strong>Remark</strong></h5></td>
                                                
                                                </tr>
                                                
                                     
                                                <tr>
                                                    <td class="center" colspan="3"> <h4><strong><span id="15"> </span></strong></h4></td>
...
$(document).ready(function(){
  ...
  if (id !=''){
   ...
   $.ajax({
    ...
    url: "test_query/fetch_urine.php", // Url to which the request is send
