...
?>
                                                ...
                                                <tr>
                                                    <td class="center"><?php echo $row['testing_report_id'];  ?></td>
                                                    <td class="center"><?php echo $row['pres_id'];  ?></td>
                                                    <td class="center"><?php echo $row['date'];  ?></td>


                                                    <td class="center"><a href="test_select.php?testing_schedule_id=<?php echo $row['testing_report_id'];?>&presid=<?php echo $row['pres_id'];?>" class="ad-st-view">Go!!</a></td>
