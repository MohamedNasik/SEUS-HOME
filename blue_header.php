                    ...
                    <div class="col-md-12">
                        ...
                        <div class="main-menu">
                            <ul>
                                ...
                                <li class="about-menu">
                                    <a href="about.php" class="mm-arr">Departments</a>
                                    <!-- MEGA MENU 1 -->
                                    <div class="mm-pos">
                                        <div class="about-mm m-menu">
                                            <div class="m-menu-inn">
                                                ...
                                                <div class="mm1-com mm1-s3">
                                                    <ul>
                                                        <li><a href="all-courses.php">Surgical Department </a></li>
                                                        <li><a href="course-details.php">Cardioology </a></li>
                                                        <li><a href="about.php">Medical Lab </a></li>
                                                        <li><a href="admission.php">Neurology </a></li>
                                                        <li><a href="awards.php">Gastroenterology
                                                            </a></li>
                                                    </ul>
                                                </div>
                                                <div class="mm1-com mm1-s4">
                                                    <ul>
                                                        <li><a href="dashboard.php">Plastic Surgery </a></li>
                                                        <li><a href="db-courses.php">Dental Care</a></li>
                                                        <li><a href="db-exams.php">Ophthalmology</a></li>
                                                        <li><a href="db-profile.php">Traumotology</a></li>
                                                        <li><a href="db-time-line.php">Psychological</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="admi-mm m-menu">
                                            <div class="m-menu-inn">
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="seminar.php">
                                                    ...
                                                    <a href="seminar.php" class="mm-r-m-btn">Read more</a>
                                                ...
                                                <div class="mm2-com mm1-com mm1-s4">
                                                    ...
                                                    <ul>
                                                        <li><a href="all-courses.php">Channaling Services </a></li>
                                                        <li><a href="course-details.php">Emergency Services </a></li>
                                                        <li><a href="about.php">Homecare Services </a></li>
                                                        <li><a href="admission.php">laboratory research </a></li>
                                                        <li><a href="awards.php">RMI Services
                                                            </a></li>
                                                        <li><a href="dashboard.php">Online appointments
                                                            </a></li>
                                                        <li><a href="db-courses.php">Dental Care</a></li>
                                                        <li><a href="db-exams.php">Surgery</a></li>
                                ...
                                <li><a href="dashboard.php">Patient</a>
                                </li>
