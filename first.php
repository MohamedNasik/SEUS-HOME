...
$stmt = $con->prepare("SELECT * FROM prescription WHERE p_id= ?  AND date=? AND user_id=?");
$stmt->bind_param("sss",$_SESSION['p_id'],$apt_date,$user);
$stmt->execute();
...
?>
                    ...
                    ?>
                            <span class="list-enq-name"> Dr. <?php  echo  $doctorname; ?> (
                                <?php  echo  $specilization;   ?> )</span> <br>

                            <ul class="nav nav-tabs tab-list">
                                <li class="active"><a data-toggle="tab" href="#home" aria-expanded="true"><i
                                            class="fa fa-user-md" aria-hidden="true"></i> <span>Investigation
                                            Details</span></a>
                                </li>
                                <li class=""><a data-toggle="tab" href="#menu1" aria-expanded="false"><i
                                            class="fa fa-bed" aria-hidden="true"></i> <span> Medicine Details</span></a>
                                </li>
                                <li class=""><a data-toggle="tab" href="#menu2" aria-expanded="false"><i
                                            class="fa fa-flask" aria-hidden="true"></i> <span>Testing Details</span></a>
                                </li>
                            ...
                            <div class="tab-content">
                                <div id="home" class="tab-pane fade  active in">
                                    ...
                                    <div class="bor">
                                        ...
                                        <div class="bor">
                                            <span> <strong> Past History: </strong> </span>
                                            <br><br>
                                            <?php echo $object['history'] ?>
                                        </div>

                                        <div class="bor">
                                            <span> <strong> Investigations: </strong> </span>
                                            <br><br>
                                            <?php echo $object['investigations'] ?>
                                        </div>
                                        <?php       
