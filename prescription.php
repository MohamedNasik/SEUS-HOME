            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    ...
                    <li><a href="admin.php"><i class="fa fa-home" aria-hidden="true"></i> Home</a>
                        ...
                        <li class="active-bre"><a href="admin.php"> Apppointments</a>
                        </li>
...
$sqli = "SELECT * FROM appointment as ap INNER JOIN users as u ON ap.user_id=u.user_id AND p_id= '".$_SESSION['p_id']."' AND doctor_status='1' AND type='Consultation' ORDER BY apt_id DESC ";
...
?>
                                                ...
                                                <tr>
													...
													<td><a href="first.php?aptid=<?php  echo base64_encode($row['apt_id']);   ?>& doctor_name=<?php  echo base64_encode($row["fname"].' '. $row["lname"]); ?>& specilization=<?php  echo base64_encode($row['specilization']); ?>&apt_date=<?php  echo base64_encode($row['apt_date']); ?>&user=<?php  echo base64_encode($row['user_id']); ?>&no=<?php  echo $row['No']; ?>  " class="ad-st-view">View Prescription</a></td>
                                                </tr>
                                                <?php  } }} ?>
                                            </tbody>
                                        </table>
